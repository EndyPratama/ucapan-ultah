...
const animationTimeline = () => {
    ...
    tl.to(".container", 0.6, { visibility: "visible" })
        ...
        // .to(".six", 0.9, { opacity: 0, y: 30, zIndex: "-1" },"+=1")
        .to(".six")
        
        // Durasi lebih lama pada bagian video, dengan halaman terakhir
        // .to(".video-slide", 10, { opacity: 1, scale: 1, ease: Expo.easeOut })  // Slide video lebih lama
        // .to(".video-slide", 0.5, { opacity: 0 }, "+=4")  // Setelah durasi video selesai, fade out
        // .to(".final-page", 1, { visibility: "visible", opacity: 1 }, "+=0.5"); // Halaman terakhir muncul
};
